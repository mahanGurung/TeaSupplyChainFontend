...
//   const [nft] = useGlobalState('nft');
  ...
  const { buyFromMan } = useBlockchain();
  ...
  const handleSubmit = async (e) => {
    ...
    if (!productId || !quantity) return;
      ...
      try {
        ...
        const productTotalPrice = quantity;
        const nftData  = { id: productId, quantity: quantity, productTotalPrice: productTotalPrice};

        await buyFromMan(nftData);
        resetForm();
